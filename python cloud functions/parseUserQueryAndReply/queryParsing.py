...
def PyJsHoisted_queryParser__(userMessage, this, arguments, var=var):
    ...
    var.get('console').callprop('log', (Js('1st parse query is:')+var.get('parsedResult').get('userMessage')))
    ...
    var.get('console').callprop('log', (Js('2nd parse query is:')+var.get('parsedResult').get('userMessage')))
    ...
    var.get('console').callprop('log', (Js('3rd parse query is:')+var.get('parsedResult').get('userMessage')))
    ...
    var.get('console').callprop('log', (Js('4th parse query is:')+var.get('parsedResult').get('userMessage')))
    ...
    var.get('console').callprop('log', (Js('5th parse query is:')+var.get('parsedResult').get('userMessage')))
    var.get('parsePercent')(var.get('parsedResult'))
    var.get('console').callprop('log', (Js('6th parse query is:')+var.get('parsedResult').get('userMessage')))
